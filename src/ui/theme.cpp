...
Theme get_light_theme() {
    ...
    theme.foreground_dim   = hex_to_imgui(0x6b6560);
    ...
    theme.ansi.yellow        = hex_to_imgui(0xd65d0e);
    theme.ansi.blue          = hex_to_imgui(0x076678);
    theme.ansi.magenta       = hex_to_imgui(0xb16286);
    theme.ansi.cyan          = hex_to_imgui(0x458588);
    theme.ansi.white         = hex_to_imgui(0xd5c4a1);
    theme.ansi.bright_black  = hex_to_imgui(0x6b6560);
    theme.ansi.bright_red    = hex_to_imgui(0xcc241d);
    theme.ansi.bright_green  = hex_to_imgui(0x98971a);
    theme.ansi.bright_yellow = hex_to_imgui(0xfe8019);
    theme.ansi.bright_blue   = hex_to_imgui(0x458588);
    theme.ansi.bright_magenta= hex_to_imgui(0xd3869b);
    theme.ansi.bright_cyan   = hex_to_imgui(0x689d6a);
    theme.ansi.bright_white  = hex_to_imgui(0xfbf1c7);
